package project.skripsi.enggyheroedi.activity;
...
import project.skripsi.enggyheroedi.adapter.DrawerAdapter;
...
import project.skripsi.enggyheroedi.fragment.PoiListFragment;
import project.skripsi.enggyheroedi.listener.OnSearchListener;
import project.skripsi.enggyheroedi.utility.ResourcesHelper;
import project.skripsi.enggyheroedi.view.DrawerDividerItemDecoration;
import project.skripsi.enggyheroedi.view.ScrimInsetsFrameLayout;
...
public class MainActivity extends ActionBarActivity implements DrawerAdapter.CategoryViewHolder.OnItemClickListener, OnSearchListener
{
	...
	private void loadCategoryList()
	{
		...
		all.setImage("drawable://" + R.mipmap.ic_category_all);
		...
		favorites.setImage("drawable://" + R.mipmap.ic_catgory_fav);
