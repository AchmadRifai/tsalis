package project.skripsi.tsalis.fragment;
...
import project.skripsi.tsalis.R;
import project.skripsi.tsalis.activity.MapActivity;
import project.skripsi.tsalis.activity.PoiDetailActivity;
import project.skripsi.tsalis.adapter.PoiListAdapter;
import project.skripsi.tsalis.adapter.SearchSuggestionAdapter;
import project.skripsi.tsalis.content.PoiSearchRecentSuggestionsProvider;
import project.skripsi.tsalis.database.DatabaseCallListener;
import project.skripsi.tsalis.database.DatabaseCallManager;
import project.skripsi.tsalis.database.DatabaseCallTask;
import project.skripsi.tsalis.database.data.Data;
import project.skripsi.tsalis.database.model.PoiModel;
import project.skripsi.tsalis.database.query.PoiReadAllQuery;
import project.skripsi.tsalis.database.query.PoiReadByCategoryQuery;
import project.skripsi.tsalis.database.query.PoiReadFavoritesQuery;
import project.skripsi.tsalis.database.query.PoiSearchQuery;
import project.skripsi.tsalis.database.query.Query;
import project.skripsi.tsalis.dialog.AboutDialogFragment;
import project.skripsi.tsalis.geolocation.Geolocation;
import project.skripsi.tsalis.geolocation.GeolocationListener;
import project.skripsi.tsalis.listener.OnSearchListener;
import project.skripsi.tsalis.utility.LocationUtility;
import project.skripsi.tsalis.utility.Logcat;
import project.skripsi.tsalis.view.GridSpacingItemDecoration;
import project.skripsi.tsalis.view.ViewState;
