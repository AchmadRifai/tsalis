package project.skripsi.enggyheroedi.fragment;
...
import project.skripsi.enggyheroedi.R;
import project.skripsi.enggyheroedi.activity.MapActivity;
import project.skripsi.enggyheroedi.activity.PoiDetailActivity;
import project.skripsi.enggyheroedi.adapter.PoiListAdapter;
import project.skripsi.enggyheroedi.adapter.SearchSuggestionAdapter;
import project.skripsi.enggyheroedi.content.PoiSearchRecentSuggestionsProvider;
import project.skripsi.enggyheroedi.database.DatabaseCallListener;
import project.skripsi.enggyheroedi.database.DatabaseCallManager;
import project.skripsi.enggyheroedi.database.DatabaseCallTask;
import project.skripsi.enggyheroedi.database.data.Data;
import project.skripsi.enggyheroedi.database.model.PoiModel;
import project.skripsi.enggyheroedi.database.query.PoiReadAllQuery;
import project.skripsi.enggyheroedi.database.query.PoiReadByCategoryQuery;
import project.skripsi.enggyheroedi.database.query.PoiReadFavoritesQuery;
import project.skripsi.enggyheroedi.database.query.PoiSearchQuery;
import project.skripsi.enggyheroedi.database.query.Query;
import project.skripsi.enggyheroedi.dialog.AboutDialogFragment;
import project.skripsi.enggyheroedi.geolocation.Geolocation;
import project.skripsi.enggyheroedi.geolocation.GeolocationListener;
import project.skripsi.enggyheroedi.listener.OnSearchListener;
import project.skripsi.enggyheroedi.utility.LocationUtility;
import project.skripsi.enggyheroedi.utility.Logcat;
import project.skripsi.enggyheroedi.view.GridSpacingItemDecoration;
import project.skripsi.enggyheroedi.view.ViewState;
...
public class PoiListFragment extends TaskFragment implements DatabaseCallListener, GeolocationListener, PoiListAdapter.PoiViewHolder.OnItemClickListener
{
	...
	public void onGeolocationRespond(Geolocation geolocation, final Location location)
	{
		runTaskCallback(new Runnable()
		{
			public void run()
			{
				...
				calculatePoiDistances();
				sortPoiByDistance();
				if(mAdapter!=null && mLocation!=null && mPoiList!=null && mPoiList.size()>0) mAdapter.notifyDataSetChanged();
			}
		});
	}
	...
	{
		if(mLocation!=null && mPoiList!=null && mPoiList.size()>0)
		{
