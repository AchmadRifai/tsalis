...
import project.skripsi.enggyheroedi.database.query.PoiReadQuery;
...
import project.skripsi.enggyheroedi.listener.AnimateImageLoadingListener;
import project.skripsi.enggyheroedi.utility.LocationUtility;
import project.skripsi.enggyheroedi.utility.Logcat;
import project.skripsi.enggyheroedi.utility.ResourcesHelper;
import project.skripsi.enggyheroedi.view.ObservableStickyScrollView;
...
public class PoiDetailFragment extends TaskFragment implements DatabaseCallListener, GeolocationListener
{
	...
	private void renderViewDescription()
	{
		...
		{
			//descriptionTextView.setText("<html><head></head><body style=\"text-align:justify;\">"+mPoi.getDescription()
			//		+"</body></html>");
